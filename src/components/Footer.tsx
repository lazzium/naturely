...
export default function Footer() {
    return (
        <footer className="w-full relative px-4 md:px-8 py-12 md:py-20 bg-gradient-to-b from-[#e8f3fa] via-[#e1eff8] to-[#d6eaed]">
            {/* Top CTA Section */}
            ...
            {/* Main Footer Box */}
            <div className="w-full max-w-[96%] xl:max-w-[98%] mx-auto bg-white/95 backdrop-blur-sm rounded-[32px] md:rounded-[40px] shadow-sm p-8 md:p-12 lg:p-16 border border-white relative overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-10">
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center w-full max-w-[340px]">
                                ...
                                />
                                <button className="absolute right-1.5 px-6 py-2.5 bg-[#0A1128] text-white rounded-full text-sm font-medium hover:bg-[#152a42] transition-colors">
                                    S'inscrire
                                </button>
                            </div>
                    ...
                    {/* Right Columns: Links */}
                    <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10 lg:pl-8">
                        <div>
                        ...
                        <div>
                            <h4 className="text-gray-500 mb-6 text-[13px] font-medium tracking-wide">Fun High Tech</h4>
                            <ul className="space-y-5">
                                <li><a href="#" className="text-gray-800 hover:text-brand-blue transition-colors text-sm font-semibold">Fun High Tech School</a></li>
                                <li><a href="#" className="text-gray-800 hover:text-brand-blue transition-colors text-sm font-semibold">Fun High Tech Sarl</a></li>
                                <li><a href="#" className="text-gray-800 hover:text-brand-blue transition-colors text-sm font-semibold">Fun High Tech Center</a></li>
                            </ul>
                        </div>
                        <div>
