        ...
        rightContent: () => (
            <>
                ...
                <div className="relative z-10 flex flex-col h-full justify-center text-white max-w-5xl mx-auto w-full">
                    <div className="inline-block px-4 py-1.5 bg-white/20 backdrop-blur-md text-white rounded-none text-xs font-semibold uppercase tracking-wider mb-8 w-max shadow-sm border border-white/20">Fondation</div>
        ...
        rightContent: () => (
            <>
                ...
                <div className="relative z-10 flex flex-col h-full justify-center items-center w-full max-w-4xl mx-auto">
                    <div className="inline-block px-4 py-1.5 bg-white/20 backdrop-blur-md text-white rounded-none text-xs font-semibold uppercase tracking-wider mb-10 shadow-sm border border-white/20">Ambition</div>
        ...
        rightContent: () => (
            <>
                ...
                <div className="relative z-10 flex flex-col h-full pr-2">
                    <div className="inline-block px-4 py-1 bg-white/20 backdrop-blur-md text-white rounded-none text-[10px] font-semibold uppercase tracking-wider mb-4 w-max shrink-0 border border-white/20">Programmes</div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full overflow-hidden">
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-none p-6 relative overflow-hidden flex-1 flex flex-col hover:bg-white/10 transition-colors">
                        ...
                        {/* Column 2: Pro & Others */}
                        <div className="flex flex-col gap-5">
                            <div className="bg-white/10 backdrop-blur-md p-6 rounded-none border border-white/20 flex-1 flex flex-col relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-2 gap-4 flex-1">
                                <div className="bg-white/10 backdrop-blur-md p-5 rounded-none border border-white/20 flex flex-col justify-center">
            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-12 relative z-10">
                ...
                <div className="flex flex-col gap-6 lg:gap-10">
                        ...
                        {contentData.map((item) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`cursor-pointer overflow-hidden transition-all duration-300 backdrop-blur-md border ${isActive ? 'bg-white text-brand-blue rounded-none p-6 shadow-2xl border-white scale-[1.02]' : 'bg-white/10 hover:bg-white/20 border-white/20 text-white rounded-none p-4 sm:p-5'}`}
                                >
                                    {isActive ? (
                                        <div className="flex flex-col h-full gap-2">
                                            <span className="px-3 py-1 bg-brand-blue/10 text-brand-blue rounded-none text-[10px] font-semibold uppercase tracking-wider w-max mb-3">
                                                {item.pill}
                                            </span>
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-6 hidden md:flex">
                                                {item.tags.map((tag, i) => (
                                                    <span key={i} className="px-3 py-1.5 border border-brand-blue/20 bg-brand-blue/5 rounded-none text-[11px] text-brand-blue font-medium whitespace-nowrap">
                                                        ♦ {tag}
                                                    </span>
                                                ))}
                                            </div>
                    ...
                    <div className="w-full">
                        <div className="bg-white/10 backdrop-blur-xl rounded-none p-6 sm:p-10 md:p-12 h-[600px] lg:h-[700px] xl:h-[720px] border border-white/20 flex flex-col relative overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.15)] ring-1 ring-white/10 transition-all duration-500">
